  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="sticky top-0 lg:top-0 z-10 bg-forge-surface border-b border-forge-border px-4 lg:px-10 py-5 flex items-center justify-between">
        <div>
          <p className="font-mono text-sm uppercase tracking-[0.2em] text-forge-dim mb-1">// Your progress</p>
      ...
      <div className="px-4 lg:px-10 py-8 flex flex-col gap-8">
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            <div key={stat.label} className="bg-forge-surface border border-forge-border p-4 text-center">
              ...
              <div className="font-mono text-[13px] uppercase tracking-[0.15em] text-forge-dim mt-1">{stat.label}</div>
            </div>
          ))}
        </div>
              ...
              <div className="border border-forge-border bg-forge-surface2/50 p-4 space-y-3">
                <div className="flex flex-wrap gap-3">
                  <div className="flex flex-col gap-1.5">
                    <label className="font-mono text-[13px] uppercase tracking-wider text-forge-dim">Type</label>
                    <select
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="font-mono text-[13px] uppercase tracking-wider text-forge-dim">Status</label>
                    <select
                      className="forge-input text-sm py-1"
                      value={filterStatus}
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="font-mono text-[13px] uppercase tracking-wider text-forge-dim">Sort</label>
                    <select
                      className="forge-input text-sm py-1"
                      value={sortBy}
                ...
                {(filterType !== 'all' || filterStatus !== 'all') && (
                  <p className="font-mono text-sm text-forge-amber">
        ...
        <section>
          <div className="flex items-center justify-between mb-5">
            ...
            <button onClick={() => setAddModalOpen(true)} className="forge-btn-ghost flex items-center gap-1.5 text-sm">
              <Plus size={11} /> Add
            </button>
          </div>
          ...
          {!goalsLoaded ? (
            ...
            >
              ...
              <p className="font-mono text-[13px] text-forge-muted mb-5">"A goal without a plan is just a wish."</p>
            ...
            <div className="border border-dashed border-forge-border text-center py-12">
              ...
              <button
                ...
                className="font-mono text-sm text-forge-amber hover:text-forge-text transition-colors mt-2"
              >
                Clear filters
              </button>
            </div>
                  ...
                  <div className="flex items-center gap-1.5">
                    {Array.from({ length: totalPages }, (_, i) => (
                      <button
                        key={i}
                        onClick={() => setPage(i)}
                        className={`w-7 h-7 font-mono text-sm border transition-colors ${i === currentPage
